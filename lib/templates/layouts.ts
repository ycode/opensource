...
export const layoutTemplates: Record<string, LayoutTemplate> = {
  ...
  'blog-posts-003': {
    category: 'Blog posts',
    previewImage: '/layouts/blog-posts-003.webp',
    template: {
      'name': 'section',
      'open': false,
      'design': {
          ...
          'children': [
            {
              ...
              'children': [
                ...
                },
                {
                  ...
                  'classes': 'grid w-[100%] gap-[56px] max-lg:grid-cols-[repeat(1,_1fr)] grid-cols-[repeat(3,_1fr)]',
                  'customName': 'Grid',
                  'children': [
                    {
                      'name': 'div',
                      ...
                      'classes': 'flex flex-col items-start gap-[20px] justify-between',
                      'customName': 'Rows',
                      'children': [
                        {
                          'name': 'div',
                                      ...
                                      'content': [
                                        {
                                          ...
                                          'content': [
                                            {
                                              'type': 'text',
                                              'text': 'Building a polished, professional website has never been simpler. Follow these steps to quickly design a stunning site that meets all your needs.'
                                            }
                                          ]
                                        }
                                      ]
                                      ...
                                      'content': [
                                        {
                                          ...
                                          'content': [
                                            {
                                              'type': 'text',
                                              'text': 'Speed up your website creation process while maintaining quality. Discover the best tools to streamline your workflow and deliver amazing results faster.'
                                            }
                                          ]
                                        }
                                      ]
                                      ...
                                      'content': [
                                        {
                                          ...
                                          'content': [
                                            {
                                              'type': 'text',
                                              'text': 'Learn how to create websites that look great on any device. This guide covers everything you need to know to build fully responsive, mobile-friendly websites.'
                                            }
                                          ]
                                        }
                                      ]
                                  ...
                                  'variables': {
                                    'image': {
                                      'src': {
                                        'type': 'dynamic_text',
                                        'data': {
                                          'content': 'https://app.ycode.com/images/layouts/user-profile-3.jpg'
                                        }
                                      },
                                      'alt': {
                                        'data': {
  ...
  'blog-posts-004': {
    category: 'Blog posts',
    previewImage: '/layouts/blog-posts-004.webp',
    template: {
      'name': 'section',
      'open': false,
      'design': {
      ...
      'children': [
        {
          ...
          'classes': 'flex flex-col w-[100%] pl-[32px] pr-[32px] max-w-[1024px]',
          'customName': 'Container',
          'children': [
            {
              'name': 'div',
              ...
              'children': [
                ...
                },
                {
                  ...
                  'classes': 'w-[100%] gap-[56px] max-lg:grid-cols-[repeat(1,_1fr)] grid-cols-[repeat(2,_1fr)] flex flex-col',
                  'customName': 'Grid',
                  'children': [
                    {
                      'name': 'div',
                      ...
                      'classes': 'gap-[32px] max-md:flex max-md:flex-col flex flex-row',
                      'customName': 'Columns',
                      'children': [
                        {
                          'name': 'div',
                          ...
                          'classes': 'flex flex-col w-[100%] max-w-[400px]',
                          'children': [
                            {
                              'name': 'image',
                              'design': {
                        ...
                        },
                        {
                          ...
                          'children': [
                            ...
                            {
                              'name': 'hr',
                              'classes': 'border-t border-[#d1d5db] w-[100%]',
                              'design': {
                                'borders': {
                                  'isActive': true,
                                  'borderWidth': '1px 0 0 0',
                                          ...
                                          'content': [
                                            {
                                              ...
                                              'content': [
                                                {
                                                  'type': 'text',
                                                  'text': 'Ultimate guide to building responsive websites '
                                                }
                                              ]
                                            }
                                          ]
  ...
  'blog-posts-005': {
    category: 'Blog posts',
    previewImage: '/layouts/blog-posts-005.webp',
    template: {
      'name': 'section',
      'open': false,
      'design': {
                              ...
                              'variables': {
                                'image': {
                                  'src': {
                                    'type': 'dynamic_text',
                                    'data': {
                                      'content': 'https://app.ycode.com/images/layouts/image-adDzF0cqVI0ncLnZgH3cAPMeLWCaFTIK2vVLY5E6.webp'
                                    }
                                  },
                                  'alt': {
                                    'data': {
  ...
  'blog-posts-006': {
    category: 'Blog posts',
    previewImage: '/layouts/blog-posts-006.webp',
    template: {
      'name': 'section',
      'open': false,
      'design': {
          ...
          'children': [
            {
              ...
              'children': [
                ...
                },
                {
                  ...
                  'classes': 'grid w-[100%] gap-[56px] max-lg:grid-cols-[repeat(1,_1fr)] grid-cols-[repeat(1,_1fr)]',
                  'children': [
                    {
                      'name': 'div',
                      'open': false,
                      ...
                      'children': [
                        {
                          ...
                          'classes': 'flex flex-col w-[100%] max-w-[220px]',
                          'children': [
                            {
                              'name': 'image',
                              'design': {
  ...
  'blog-headers-001': {
    ...
    previewImage: '/layouts/blog-headers-001.webp',
    template: {
      'name': 'section',
      'open': false,
      'design': {
      ...
      'children': [
        {
          ...
          'children': [
            {
              'name': 'div',
              'classes': 'flex flex-col items-center gap-z16 gap-[72px]',
              'design': {
                'layout': {
                  'isActive': true,
                  'display': 'Flex',
              ...
              'children': [
                {
                  ...
                  'classes': 'flex flex-col w-[100%] max-w-[767px] gap-[32px]',
                  'customName': 'Rows',
                  'children': [
                    {
                      'name': 'text',
  ...
  'blog-headers-002': {
    category: 'Blog header',
    previewImage: '/layouts/blog-headers-002.webp',
    template: {
      'name': 'section',
      'open': false,
      'design': {
              ...
              'children': [
                {
                  ...
                  'classes': 'flex flex-col w-[100%] gap-[32px]',
                  'customName': 'Rows',
                  'children': [
                    {
                      'name': 'text',
                    ...
                    },
                    {
                      ...
                      'children': [
                        {
                          'name': 'div',
                          'classes': 'flex flex-col bg-[#000000]/5 pt-[6px] pb-[6px] rounded-[100px] pl-[12px] pr-[12px]',
                          'design': {
                            'layout': {
                              'isActive': true,
                              'display': 'Flex',
                  ...
                  'children': [
                    {
                      ...
                      'classes': 'w-[100%] rounded-[24px] object-cover',
                      'settings': {
                        'tag': 'img'
                      },
                      'variables': {
  ...
  'blog-headers-003': {
    category: 'Blog header',
    previewImage: '/layouts/blog-headers-003.webp',
    template: {
      'name': 'section',
      'open': false,
      'design': {
      ...
      'classes': 'flex flex-col items-center w-[100%] bg-[#ffffff] pt-[100px] pb-[100px]',
      'children': [
        {
          'name': 'div',
          'open': false,
              ...
              'children': [
                {
                  ...
                  'classes': 'flex flex-col w-[100%] max-w-ė max-w-ė max-w-ė00 max-w-[400px] items-start max-lg:max-w-[100%] gap-[32px]',
                  'children': [
                    {
                      'name': 'text',
                      'design': {
                      ...
                      'variables': {
                        'image': {
                          'src': {
                            'type': 'dynamic_text',
                            'data': {
                              'content': 'https://app.ycode.com/images/layouts/image-0wcZjzA1Jm9gJ9Adz0FOPH1vMuBtPSDfKK1joZRq.webp'
                            }
                          },
                          'alt': {
                            'data': {
  ...
  'blog-headers-004': {
    category: 'Blog header',
    previewImage: '/layouts/blog-headers-004.webp',
    template: {
      'name': 'section',
      'open': false,
      'design': {
      ...
      'children': [
        {
          ...
          'classes': 'flex flex-col max-w-[1280px] w-[100%] pl-[32px] pr-[32px] relative z-[10] items-center',
          'customName': 'Container',
          'children': [
            {
              'name': 'div',
              ...
              'classes': 'flex flex-col w-[100%] max-w-[768px] items-center gap-[32px]',
              'customName': 'Rows',
              'children': [
                {
                  'name': 'text',
                ...
                },
                {
                  ...
                  'classes': 'font-[700] tracking-[-0.02em] max-md:text-[36px] text-[48px] leading-[1.1] text-center text-[#ffffff]',
                  'settings': {
                    'tag': 'h1'
                  },
                  'variables': {
                ...
                },
                {
                  ...
                  'classes': 'gap-[16px] items-center flex flex-col justify-center',
                  'customName': 'Columns',
                  'children': [
                    {
                      'name': 'div',
                      ...
                      'children': [
                        {
                          ...
                          'classes': 'text-[14px] font-[500] text-center text-[#ffffff]',
                          'settings': {
                            'tag': 'p'
                          },
                          'variables': {
                          ...
                          'children': [
                            {
                              ...
                              'classes': 'text-[14px] text-[#ffffff]/60',
                              'settings': {
                                'tag': 'p'
                              },
                              'variables': {
                            ...
                            {
                              'name': 'hr',
                              'classes': 'border-r-[1px] w-[1px] h-[12px] border-[#ffffff]/25',
                              'design': {
                                'borders': {
                                  'isActive': true,
                                  'borderWidth': '1px 0 0 0',
                                  'borderColor': '#ffffff/25',
                                  'borderRightWidth': '1'
                                },
                                'sizing': {
                                  'width': '1',
