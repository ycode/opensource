...
import { extractCanvasCSS } from '../lib/extract-tailwind-css';
...
export const usePagesStore = create<PagesStore>((set, get) => ({
  ...
  saveDraft: async (pageId) => {
    ...
    set({ isLoading: true, error: null });
    try {
      // Extract CSS generated by Play CDN
      const generatedCSS = extractCanvasCSS();
      
      console.log('💾 Saving draft with generated CSS:', {
