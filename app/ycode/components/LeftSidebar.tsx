          ...
          >
            <div className="py-4">
              <div className="flex items-center justify-between mb-4">
                ...
                >
                  <svg
                    className="w-4 h-4 text-zinc-400" fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
              ...
              {!currentPageId ? (
                <div className="text-center py-8 text-zinc-500">
                  <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-zinc-800 flex items-center justify-center">
                    <svg
                      className="w-6 h-6 text-zinc-600" fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path
              ...
              <div className="space-y-1">
                {pages.map((page) => (
                  ...
                  >
                    ...
                    >
                      <svg
                        className="w-4 h-4 text-zinc-400 shrink-0" fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path
                          fillRule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z"
                          clipRule="evenodd"
                        />
                      </svg>
